...
const styles = StyleSheet.create({
  ...
  goalBlob: { position: 'absolute', top: -50, right: -40, width: 150, height: 150, borderRadius: 75, backgroundColor: 'rgba(244,246,246,0.06)' },
  goalHead: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  goalEyebrow: { fontFamily: font.bold, fontSize: 10.5, color: 'rgba(244,246,246,0.6)', letterSpacing: 2 },
  onTrackChip: { backgroundColor: 'rgba(244,246,246,0.16)', borderRadius: 20, paddingHorizontal: 9, paddingVertical: 4 },
  ...
  goalTrack: { height: 7, backgroundColor: 'rgba(244,246,246,0.18)', borderRadius: 4, overflow: 'hidden', marginTop: 14 },
  goalFill: { height: '100%', backgroundColor: CREAM, borderRadius: 4 },
  goalMeta: { fontFamily: font.regular, fontSize: 12, color: 'rgba(244,246,246,0.7)', marginTop: 8 },
