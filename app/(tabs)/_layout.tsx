...
const styles = StyleSheet.create({
  ...
  divider: { width: 1, height: 26, backgroundColor: 'rgba(196,196,196,0.15)', marginHorizontal: 8 },
  plusBtn: {
    width: 46, height: 46, borderRadius: 23,
    overflow: 'hidden',
    borderWidth: 1, borderColor: 'rgba(196,196,196,0.35)',
    alignItems: 'center', justifyContent: 'center',
    shadowColor: '#165B74', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.35, shadowRadius: 12,
  },
